...
@REM 	call :concat "%%i"
@REM )
call :concat "%BASE_DIR%\examples\build\libs\kafka-examples\*"

rem Classpath addition for kafka-clients
@REM for %%i in ("%BASE_DIR%\clients\build\libs\kafka-clients*.jar") do (
@REM 	call :concat "%%i"
@REM )
call :concat "%BASE_DIR%\clients\build\libs\kafka-clients\*"
...
call :concat "%BASE_DIR%\streams\build\libs\kafka-streams\*"
...
call :concat "%BASE_DIR%\streams\examples\build\libs\kafka-streams-examples\*"

@REM for %%i in ("%BASE_DIR%\streams\build\dependant-libs-%SCALA_VERSION%\rocksdb*.jar") do (
@REM 	call :concat "%%i"
@REM )

call :concat "%BASE_DIR%\streams\build\dependant-libs-%SCALA_VERSION%\rocksdb\*"
...
call :concat "%BASE_DIR%\tools\build\libs\kafka-tools\*"
